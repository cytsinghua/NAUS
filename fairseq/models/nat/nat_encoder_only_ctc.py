...
class NATransformerModel(FairseqNATModel):
    def __init__(self, args, encoder, decoder):
        ...
        self.use_bert_weights = args.use_bert_weights
        ...
        #     # If we are using bert as the encoder, we disable the original encoder to avoid errors
        #     def bert_encoder(src_tokens, src_lengths, temp):
...
@register_model_architecture(
    "nat_encoder_only_ctc", "nat_encoder_only_ctc_fixlen"
)
...
@register_model_architecture(
    "nat_encoder_only_ctc", "nat_encoder_only_ctc_refine"
)
