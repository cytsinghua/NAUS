...
class FairseqNATModel(TransformerModel):
    ...
    def __init__(self, args, encoder, decoder):
        ...
        self.force_length = args.force_length  # whether using our length control algorithm to force generating summary of a specific length
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        if args.use_bert_tokens:
            # change layers to 12 to make a fair comparison with bert
...
class FairseqNATSharedDecoder(TransformerSharedDecoder):
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        super().__init__(args, dictionary, embed_tokens, no_encoder_attn)
        self.ensemble_models = None