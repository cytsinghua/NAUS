...
@register_model("nat_encoder_only_customized_no_repeat_ctc")
class NATransformerModel(FairseqNATModel):
    ...
    def set_decode_function(self, decode_function):
        self.bert_decode_function = decode_function
    ...
    def forward(
        ...
        if self.use_bert_weights:
            ...
            bert_input_sample = src_tokens[:, 1:]
            ...
            src_lengths -= 1
            last_hidden_state = self.bert_model(bert_input_sample).last_hidden_state
    ...
    def forward_decoder(self, decoder_out, encoder_out, decoding_format=None, **kwargs):
        ...
        # execute the decoder
        if self.use_bert_weights:
            # If we use the bert as the encoder, the encoder output is directly the required logits
...
@register_model_architecture(
    "nat_encoder_only_customized_no_repeat_ctc", "nat_encoder_only_customized_no_repeat_ctc"
)
...
@register_model_architecture(
    "nat_encoder_only_customized_no_repeat_ctc", "nat_encoder_only_customized_no_repeat_ctc_fixlen"
)
...
@register_model_architecture(
    "nat_encoder_only_customized_no_repeat_ctc", "nat_encoder_only_customized_no_repeat_ctc_refine"
)
